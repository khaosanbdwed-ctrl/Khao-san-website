    ...
    return (
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '24px', marginBottom: '48px' }}>
                {stats.map((stat, i) => (
                    <div key={i} style={{ backgroundColor: 'var(--color-surface-base)', padding: '32px', borderRadius: '12px', border: '1px solid var(--color-border)' }}>
            ...
            <div style={{ backgroundColor: 'var(--color-surface-base)', padding: '40px', borderRadius: '12px', border: '1px solid var(--color-border)', textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--color-text-secondary)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.7 }}>
                    The backend API structure is fully prepared. Once you provide the Supabase and Analytics credentials, this dashboard will instantly connect and display real-time data from your live systems. Use the sidebar to manage your menu.
                </p>
            </div>
